(function ($){
  ...
  $.fn.ratingOpenPopup = function () {
    ...
    var htmlPopup = "<div class='col-xs-12 col-sm-10 col-md-6 col-lg-4 no-padding rating-popup'> <div class='row rating-popup-title'> <span>Đánh giá khoá học</span> <i class='fa fa-times rating-popup-close'></i> </div> <div class='row rating-popup-main'> <div class='row no-margin'> <span>Đánh giá :</span> <ul class='no-padding rating'> <li> <i class='mdi-action-grade star rated' val='1'></i> </li> <li> <i class='mdi-action-grade star rated' val='2'></i> </li> <li> <i class='mdi-action-grade star rated' val='3'></i> </li> <li> <i class='mdi-action-grade star rated' val='4'></i> </li> <li> <i class='mdi-action-grade star' val='5'></i> </li> </ul> </div> <form> <input name='star' type='hidden' value='5'> <input class='form-control' placeholder='Tiêu đề'> <textarea class='form-control' placeholder='Nội dung'></textarea> <button class='btn btn-primary'>Đánh giá</button> </form> </div> </div> ";
    this.click( function () {
